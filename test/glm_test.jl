...
begin
	using Statistics, Distributions, StatsBase, Random, LinearAlgebra, DelimitedFiles, Distributed, GLM, PlutoUI,Plots
end


# ╔═╡ 4eddfd44-06ae-46c4-8dd9-d843ca70619e
begin
include(homedir()*"/GIT/SuSiEGLMM.jl/src/GLMM.jl")
	# using .SuSiEGLMM
end

# ╔═╡ 5b1a8dc4-1b1a-412e-ade4-6751b13f8b59
md" 
## simulation comparison with R-version
"

# ╔═╡ d6b57884-d5d5-4165-b384-d85f3c95d310
md"
* Set the sizes of n (row), p (column), L (single effects), B (iterations)  :
"

# ╔═╡ fe5f4aff-600f-4bd2-aecf-d15e0ad1a736
md"
n:
$(@bind n Slider(100:1000)) 
...
scatter(b_1s,b̂,xlabel= "True effects", ylabel="Posterior estimate")
...
scatter(b_1s,α̂, xlabel="True effects",ylabel="PIP")

# ╔═╡ 5e1f0018-9f06-4997-93e9-55c4f4486b4d
y=readdlm("../testdata/dataY-julia.csv")
...
scatter(B_1s,b̂1,xlabel= "True effects", ylabel="Posterior estimate",title="b̂₁")

# ╔═╡ 15bc17ae-b233-4394-a0c4-fbaec6c4fff6
scatter(B_2s,b̂2,xlabel= "True effects", ylabel="Posterior estimate",title="b̂₂")

# ╔═╡ c9c6b3b5-24fe-4949-8176-f1ee8cb36aa9
scatter(B_1s,α̂₁, xlabel="True effects",ylabel="PIP",title= "α̂₁")

# ╔═╡ 6e851362-ac85-4a3a-9be3-9108b1bb2abb
scatter(B_2s,α̂₂, xlabel="True effects",ylabel="PIP",title="α̂₂")
